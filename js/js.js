        ...
        var sel = formElement.elements[n];  
         if ((sel.selectedIndex-1)==respuestaSelect[n]) {
            ...
            if(n==0){
                ...
                darExplicacion("Aunque algunos piensen lo contrario, cometer asesinatos en la vida real no es un juego de rol.");
            } else {
                darExplicacion("Respuesta correcta: a");
                darExplicacion("Un personaje es un alter ego, un papel, una vida que creamos nosotros para jugar.");
            }
        }       
    }       
}
...
function corregirMultiple(){
    for(n=2;n<4;n++){
        ...
        if(n==2 && mal==true){
                darExplicacion("Respuestas correcta: d");
            } else if (n==3 && mal==true) {
                darExplicacion("Respuestas correcta: c, e");
            }
    ...
    for(n=4;n<6;n++){
        var txt = formElement.elements[n].value;  
         if (txt.toLowerCase()==respuestaText[n]) {
            ...
            darRespuestaHtml("- Pregunta "+(n+1)+": Incorrecta");
            if(n==4){
                darExplicacion("Respuesta correcta: rpg");
            } else {
                darExplicacion("Respuesta correcta: 100");
            }
        }
        ...
        if (nombreRadio.value==respuestaRadio[n]) {
            ...
            darRespuestaHtml("- Pregunta "+(n+1)+": Incorrecta");
             if(n==4){
                ...
                darExplicacion("Respuesta correcta: c");
                darExplicacion("Como cualquier otro juego, la principal función del rol es divertirse y pasarlo bien.");
            }
        } 
    }        
}
...
function corregirCheckbox(){
  ...
  for (n=8;n<10;n++){
    ...
    if(n==8 && mal==true){
                darExplicacion("Respuestas correcta: a, b, c, e, f, g");
            } else if (n==9 && mal==true) {
                darExplicacion("Respuestas correcta: a, b, e");
            }
  }
